...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        sendTextToElement(By.id("BillingNewAddress_FirstName"), "Harry");
        sendTextToElement(By.id("BillingNewAddress_LastName"), "Vaidya");
        sendTextToElement(By.id("BillingNewAddress_Email"), "harryvaidya@gmail.com");
        sendTextToElement(By.id("BillingNewAddress_Company"), "SHITAL Limited");
        selectByVisibleTextFromDropdown(By.id("BillingNewAddress_CountryId"), "United Kingdom");
        sendTextToElement(By.id("BillingNewAddress_City"), "London");
        sendTextToElement(By.id("BillingNewAddress_Address1"), "Union Road");
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"), "HA0 4AU");
        sendTextToElement(By.id("BillingNewAddress_PhoneNumber"), "07432689045");
